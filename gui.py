...
# Qt4 threading advice from here:
...
class SlouchingThread(QtCore.QThread):
  ...
  # Help ensure the thread quits before it's destroyed
  def __del__(self):
    self.wait()
  ...
  def run(self):
    while self.run_loop:
      ...
      # TODO: Possibly collect a certain number of readings and then only
      # bother people if all or most of the readings indicate slouching.
      # Best 2 out of 3?
